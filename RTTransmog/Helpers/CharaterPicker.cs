...
internal static partial class CharacterPicker {
    ...
    private static bool IsUnitInRangeCells(BaseUnitEntity unit, Vector3 point, int radius, bool checkLOS = true) {
    ...
    private static IEnumerable<BaseUnitEntity> GetTargetsAroundCustom(Vector3 point, int radius, bool checkLOS = true, bool includeDead = false) {
    ...
    private static readonly Dictionary<CharacterListType, TimedCache<IEnumerable<BaseUnitEntity>>> m_Lists = new() {
    ...
    public static IEnumerable<BaseUnitEntity> CurrentUnits {
        get {
